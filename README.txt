...
Each Figure has a file named "Plot_Figure_X"
python Plot_Figure_X.py will generate the figure

-Table 2 Fitness Evaluation Time Growth values are caculated in Plot_Figure_3.py
-Table 3 and 4 are generated in Plot_Figure_5 variables
